...
export default function ProfileTabs({ userId, active }) {
  ...
  const activeTabClasses =
    "flex gap-1 px-4 py-1 items-center text-socialBlue border-b-socialBlue border-b-4";
  ...
  return (
    <div>
      <div className=" mt-4 md:mt-10 flex">
        ...
        <Link
          href={`/profile/${userId}/media`}
          className={active === "media" ? activeTabClasses : tabClasses}
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
